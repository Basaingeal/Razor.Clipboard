...
window["CurrieTechnologies"]["Razor"]["Clipboard"] =
    window["CurrieTechnologies"]["Razor"]["Clipboard"] || {};
window["CurrieTechnologies"]["Razor"]["Clipboard"]["ReadText"] = function (requestId) { return __awaiter(void 0, void 0, void 0, function () {
    var text, e_1, error;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
window["CurrieTechnologies"]["Razor"]["Clipboard"]["WriteText"] = function (requestId, textToWrite) { return __awaiter(void 0, void 0, void 0, function () {
    var e_2, error;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
